...
class Task01Test {
    @Test fun funcTest1() {
        ...
        val result = pointsToCheck.map { polygon.isPointInside(it) }.toTypedArray()
    ...
    @Test fun funcTest2() {
        ...
        val result = arrayOf(Point(1, 0), Point(1,1), Point(0, 1)).map { polygon.isPointInside(it) }.toTypedArray()

        Assert.assertArrayEquals(arrayOf(true, true, true), result)
    }
}
