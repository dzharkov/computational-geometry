...
class Task01Test {
    test fun funcTest1() {
        ...
        val pointsToCheck = array(
            ...
            Point(6,0),Point(8,-1),Point(1,7),Point(6,7),Point(6,5),
            Point(16,5),Point(10,0),Point(10,-2),Point(6,-3),Point(1,-1)
        )

        val result = pointsToCheck.map { polygon.isPointInside(it) }.copyToArray()

        Assert.assertArrayEquals(
                array(true, true, true, true, true, true, true, false, false, false, false, false, false, false, false),
                result
        )
    }
}
